...
<div data-aos="fade-up" class="about-stock d-flex flex-column">
    <h3 class="text-uppercase mb-4">Карта сайта</h3>
    <div class="about-stock-wrap d-flex flex-column">
        <div class="map-row d-flex flex-sm-row flex-column justify-content-between mt-4">
            ...
            <div class="map-block2">
                ...
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="#">Правление</a></p>

                <h3 class="text-uppercase map-head2 mt-5"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1.25rem; color: #9f074f;"  href="#">Документы и публикации</a></h3>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/about-company/documents-and-publications/financial-indicators">Финансовые показатели</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/about-company/documents-and-publications/register-of-insurance-agents">Реестр страховых агентов</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/about-company/documents-and-publications/insurance-tariffs">Страховые тарифы</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/about-company/documents-and-publications">Презентации</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/about-company/documents-and-publications/insurance-rules">Правила страхования</a></p>

                <h3 class="text-uppercase map-head2 mt-5"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1.25rem; color: #9f074f;"  href="/about-company/partners-and-customers">Партнеры</a></h3>
            </div>

            <div class="map-block3">
                <h3 class="text-uppercase map-head my-3"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1.5rem; color: #9f074f;"  href="/private-clients">Частным клиентам</a></h3>
                <h3 class="text-uppercase map-head2 mt-4"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1.25rem; color: #9f074f;"  href="/private-clients">Накопительное страхование</a></h3>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/private-clients/asia_bolashak">Азия Болашақ</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/private-clients/kazina">Азия Қазына</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/private-clients/foreign-exchange">Азия Валютный</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/private-clients/azia_capital">Азия Капитал</a></p>
        ...
        <div class="map-row-2 d-flex flex-sm-row flex-column justify-content-between mt-4">
            ...
            <div class="map-block2">
                ...
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/calculator/mst">Медицинское страхование туристов</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="#">Азия Корғау</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/calculator/osrns">Обязательное страхование работника от<br> несчастных случаев</a></p>

                <h3 class="text-uppercase map-head2 mt-4"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1.25rem; color: #9f074f;"  href="#">Оплата очередного взноса по<br>
                        действующим договорам<br>
                        страхования</a></h3>
                <h3 class="text-uppercase map-head2 mt-4"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1.25rem; color: #9f074f;"  href="#">Продлить полис</a></h3>
                <h3 class="text-uppercase map-head2 mt-4"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1.25rem; color: #9f074f;"  href="#">Заказать страховую услугу</a></h3>
        ...
        <div class="map-row-3 d-flex justify-content-between flex-sm-row flex-column mt-4">
            <div class="map-block1">
                <h3 class="text-uppercase map-head my-3"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1.5rem; color: #9f074f;"  href="#">Верхнее меню</a></h3>
                <p class="map-way mt-4"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="#">Офисы компании в вашем городе</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="/cabinet">Личный кабинет</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="#">Заказать звонок</a></p>
                <p class="map-way"><a style="font-family: 'pragmatica-cyrillic', sans-serif;font-size: 1rem; color: #000;"  href="#">Выбор языка</a></p>
            </div>
