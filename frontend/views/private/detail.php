            ...
            <?php
                ...
                if(count($blogtags)>0){
                    ...
                    foreach ($blogtags as $tagkey) {
                        ...
                        ';
                        echo '<a class="text-uppercase ml-md-5 ml-0 mt-4 mt-md-0" href="/calculator/bolashak"><img class="mr-3"
                                 src="/image/about-stock-3.png" alt="">калькулятор онлайн</a>';
                        echo '<a class="text-uppercase ml-md-5 ml-0 mt-4 mt-md-0" href=""><img class="mr-3"
                                 src="/image/about-stock-4.png" alt="">страховые тарифы</a>';
                    }
                    echo '</div>';
                }
...
<div class="your-profit d-flex flex-column my-4">
    <h3 data-aos="fade-up" class="text-uppercase my-3">Ваши выгоды:</h3>
    <div data-aos="fade-up" class="items d-flex flex-md-row flex-column align-items-center justify-content-center p-3">
        <?
            $YourBenefits = \common\models\YourBenefitsBlog::find()->alias('t')->with('yourBenefits')->where('t.blog_id = '.$blog->id)->asArray()->all();
//            echo '<pre>'. print_r($v['yourBenefits'], true). '</pre>';die;
        foreach($YourBenefits as $v){?>
            <div data-aos="fade-up" class="item d-flex flex-column align-items-center justify-content-center">
