<div class="link-anchors d-flex flex-md-row flex-column mt-4">
    ...
    <a href="<?=\yii\helpers\Html::encode(\yii\helpers\Url::to(['/about-the-company/partners-and-customers']))?>">Партнеры и клиенты<img src="/image/link-arrow-right.png" alt=""></a>
    <a href="">Текст</a>
</div>
