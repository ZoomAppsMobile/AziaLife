...
<div data-aos="fade-up"  class="about-stock d-flex flex-column">
    ...
    <h3 class="text-uppercase mb-4">Полезные советы</h3>

    <?$i=1;foreach($model as $v){?>
        <div class="sovet-block d-flex">
            <p class="krug"><?=$i?></p>
            <p class="sovet-txt2"><?=$v->title?></p>
        </div>
    <?$i++;}?>

    <div class="d-flex flex-column">
        <p class="sovet-txt">Уважаемые клиенты АО "КСЖ "Asia Life", мы рады, что вы выбрали нашу компанию как надежного партнера и готовы ответить на любые ваши вопросы.</p>
        <h4 class="question">Задать вопрос</h4>
