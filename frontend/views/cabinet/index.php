        ...
        <div class="block2">
            <div class="block2__row1">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab1" data-toggle="tab" href="#profile1" role="tab" aria-controls="profile1" aria-selected="false"><?=Yii::t('main-title', 'Сообщить')?><br> <?=Yii::t('main-title', 'о страховом случае')?></a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="tab-row1 d-flex justify-content-between">
                            ...
                            <a class="block1-link" href="#"><?=Yii::t('main-title', 'Оформить договор')?></a>
                        </div>
                        <div class="tab-row2">
