...
<form action="" class="form-asia d-flex flex-column bolashak-response">
    ...
    <div class="second-row d-flex flex-md-row flex-column mb-4">
        ...
        <div class="gender-block">
            ...
            <div class="gender">
                <label><input type="radio" name="" value=""> Мужской</label>
                <label><input type="radio" name="" value=""> Женский</label>
            </div>
        </div>
    </div>
    ...
    <h4 class="text-main">Дополнительные покрытия Выгодоприобретателя</h4>

    <div class="first-row d-flex flex-md-row flex-column mb-4">
        <p class="dop-text2">Телесная травма в результате НС</p>
        <div class="select-block">
            <select id="select2" class="form-control" name="TTV">
                <option>равна страховой сумме</option>
                <option value="100000">100000</option>
                <option value="200000">200000</option>
                <option value="300000">300000</option>
        ...
        <div class="last-dynamic dynamic2">
            <input id="input-nums" class="form-control OutTTV" type="number" name="" value="">
        </div>
    </div>

    <h4 class="text-main">Дополнительные покрытия  Страхователя</h4>
    <p class="sometext">выберите в случае, если Застрахованный и Страхователь не является одним и тем же лицом</p>

    <div class="first-row d-flex flex-md-row flex-column mb-4">
        <p class="dop-text2">Освобождение от уплаты взносов в случае смерти Застрахованного</p>
        <div class="select-block">
            <select id="select2" class="form-control" name="DB">
                <option>равна страховой сумме</option>
                <option value="100000">100000</option>
                <option value="200000">200000</option>
                <option value="300000">300000</option>
        ...
        <div class="last-dynamic dynamic2">
            <input id="input-nums" class="form-control OutDB" type="number" name="" value="">
        </div>
    </div>

    <h4 class="text-main">Данные Страхователя</h4>

    <div class="second-row d-flex flex-md-row flex-column mb-4">
        <div>
            <label for="input5">Дата рождения*</label>
            <input class="form-control" type="date" id="born-control" required>
        </div>
        <div class="gender-block">
            <label for="input6">Пол</label>
            <div class="gender">
                <label><input type="radio" name="sex" value="1"> Мужской</label>
                <label><input type="radio" name="sex" value="2"> Женский</label>
            </div>
        </div>
    </div>
