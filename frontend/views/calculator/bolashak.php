...
<form action="" class="form-asia d-flex flex-column bolashak-response">
    ...
    <div class="second-row d-flex flex-md-row flex-column mb-4">
        ...
        <div class="gender-block">
            ...
            <div class="gender">
                <label><input type="radio" name="" value=""> <?=Yii::t('main-title', 'Мужской')?></label>
                <label><input type="radio" name="" value=""> <?=Yii::t('main-title', 'Женский')?></label>
            </div>
        </div>
    </div>
    ...
    <div class="second-row d-flex flex-md-row flex-column mb-4">
        ...
        <div class="gender-block">
            <label for="input6"><?=Yii::t('main-title', 'Пол')?></label>
            <div class="gender">
                <label><input type="radio" name="sex" value="1"> <?=Yii::t('main-title', 'Мужской')?></label>
                <label><input type="radio" name="sex" value="2"> <?=Yii::t('main-title', 'Женский')?></label>
            </div>
        </div>
    </div>
